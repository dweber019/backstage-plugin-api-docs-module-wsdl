...
`backstage-plugin-api-docs-module-wsdl` is [MIT licensed](LICENSE) and accepts contributions via
...
- GitHub [issues](https://github.com/dweber019/backstage-plugin-api-docs-module-wsdl/issues)
...
```
git clone git@github.com:your_github_username/backstage-plugin-api-docs-module-wsdl.git
cd backstage-plugin-api-docs-module-wsdl
git remote add upstream https://github.com/dweber019/backstage-plugin-api-docs-module-wsdl.git
git fetch upstream
```
...
```
yarn dev # starts both the frontend and backend
...
[fork]: https://github.com/dweber019/backstage-plugin-api-docs-module-wsdl/fork
